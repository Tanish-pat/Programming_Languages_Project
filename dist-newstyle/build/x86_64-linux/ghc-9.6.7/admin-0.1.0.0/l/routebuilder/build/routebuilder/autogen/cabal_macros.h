...
/* package admin-0.1.0.0 */
#ifndef VERSION_admin
#define VERSION_admin "0.1.0.0"
#endif /* VERSION_admin */
#ifndef MIN_VERSION_admin
#define MIN_VERSION_admin(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_admin */
...
#define CURRENT_PACKAGE_KEY "admin-0.1.0.0-inplace-routebuilder"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "admin-0.1.0.0-inplace-routebuilder"
